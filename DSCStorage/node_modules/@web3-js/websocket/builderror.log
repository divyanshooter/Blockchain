...
gyp ERR! stack Error: Command failed: C:\Users\Divyanshu\AppData\Local\Programs\Python\Python35\python.EXE -c import sys; print "%s.%s.%s" % sys.version_info[:3];
...
gyp ERR! cwd G:\react\blockchain\trialsec\node_modules\@web3-js\websocket
